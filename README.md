...
|---|---|---|
| 💰 Total Revenue | $9.2M | $14.7M |
| 📦 Total Profit | $985.4K | $1.5M |
| 🛒 Total Orders | 3,893 | 5,496 |
...
| Category | Profit |
|---|---|
| Office Supplies | $985.4K |
| Furniture | $331.0K |
| Technology | $206.0K |

**Office Supplies is overwhelmingly the strongest category, accounting for ~65% of total profit.**
...
| Product | Profit |
|---|---|
| Eldon ClusterMat | $22K |
| Performers Binders | $16K |
| Avery Reinforcements | $15K |
...
### Customer View
Analyzes profitability from a customer perspective — who is buying, which segments drive the most value, and how regions compare.
...
- **Region** and **Customer Segment** cross-filtering
...
This project is for portfolio and educational purposes. Data is fictional and used for demonstration only.
